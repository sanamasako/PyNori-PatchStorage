def ProgressDestroyer(): # for the Demotion item
	...
	try: print(Fore.YELLOW+"DEBUG: "+Fore.WHITE+f"Location: {location}, Steps Taken: {steps}"); print(Fore.YELLOW+f"DEBUG: {Fore.WHITE}ActiveQuirk: {ActiveQuirk}" if not DualQMode else Fore.YELLOW+f"DEBUG: {Fore.WHITE}Quirk1: {Quirk1}, Quirk2: {Quirk2}")
	except ValueError:
