def FightEnem(Yami=False):
	...
	global FoughtYami, bababooey, HasFoughtYet, DeathByDeerGod, DeathByBurn, YamiTraumatised, CantUseThisAttack, Quirk1, Quirk2, ActiveQuirk, DualQMode, DeathByDeerGodAlt, SleepCounter, ShadoArchHP, ShadoArchMaxHP, AlreadyPrayed, AlreadyDecrementedSleep, KrystalHP, KrystalMaxHP, Lightheadedness, PendingDamage, YamiFirstMiss
				...
				try:
					...
					if atk_name in AvailableAttacks:
						...
						for sis in range(AtkAmount):
							...
							elif CurE not in ["Shadorako", "Krystal", "Yami"] and EnemyHP > 0:
